...
ConstantValue* duplicateConstantValue(ConstantValue* v) {
  ...
  else result->charValue=v->charValue;
  return resultValue;
}
...
Object* createVariableObject(char *name) {
  ...
  obj->varAttrs->scope=symtab->scope;
  return obj;
}
...
Object* createFunctionObject(char *name) {
  ...
  Object *obj=(Object*)malloc(sizeof(Object));
  str(obj->name,name);
  obj->kind=OBJ_FUNTION;
  obj->funcAttrs=(FuntionAttributes*)malloc(sizeof(FunctionAttributes));
...
Object* createProcedureObject(char *name) {
  ...
  obj->proAttrs->scope=creatScope(obj,symtab->currentScope);
  return obj;
}
